...
def test_model__with_recovery_rate__expect_all_recover():
    ...
    model.add_standard_transition_flow("recovery", 1, "I", "R")
    model.run()
...
def test_model__with_complex_dynamics__expect_correct_outputs():
    ...
    model.add_standard_transition_flow("early_progression", 2, "EL", "I")
    model.add_standard_transition_flow("stabilisation", 3, "EL", "LL")
    model.add_standard_transition_flow("early_progression", 1, "LL", "I")
    model.add_death_flow("infect_death", 0.4, "I")
    model.add_standard_transition_flow("recovery", 0.2, "I", "R")
    model.add_standard_transition_flow("case_detection", 1, "I", "R")
    model.run()
